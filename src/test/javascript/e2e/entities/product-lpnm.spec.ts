...
describe('Product e2e test', () => {
    ...
    it('should load Products', () => {
        navBarPage.goToEntity('product-lpnm');
        productComponentsPage = new ProductComponentsPage();
        expect(productComponentsPage.getTitle()).toMatch(/lesnouveauxpetitsmondesStoreApp.product.home.title/);
    ...
    it('should load create Product dialog', () => {
        ...
        expect(productDialogPage.getModalTitle()).toMatch(/lesnouveauxpetitsmondesStoreApp.product.home.createOrEditLabel/);
   ...
   /* it('should create and save Products', () => {
        ...
        // productDialogPage.categoriesSelectLastOption();
        // productDialogPage.tagsSelectLastOption();
...
export class ProductComponentsPage {
    ...
    title = element.all(by.css('jhi-product-lpnm div h2 span')).first();
...
export class ProductDialogPage {
    ...
    categoriesSelect = element(by.css('select#field_categories'));
    ...
    categoriesSelectLastOption = function () {
        this.categoriesSelect.all(by.tagName('option')).last().click();
    }

    categoriesSelectOption = function (option) {
        this.categoriesSelect.sendKeys(option);
    }
    ...
    getCategoriesSelectedOption = function () {
