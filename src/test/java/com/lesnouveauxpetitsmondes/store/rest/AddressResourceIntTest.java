...
import com.lesnouveauxpetitsmondes.store.repository.AddressRepository;
import com.lesnouveauxpetitsmondes.store.service.AddressService;
import com.lesnouveauxpetitsmondes.store.repository.search.AddressSearchRepository;
...
public class AddressResourceIntTest {
    ...
    private static final String NOT_VALID_UPDATED_ZIPCODE = "BBBBBAA";

    private static final String DEFAULT_COUNTRY_CODE = "FR";
    private static final String UPDATED_COUNTRY_CODE = "BB";
    private static final String NOT_VALID_UPDATED_COUNTRY_CODE = "BBAAB";
    ...
    @Test
    @Transactional
    public void checkZipCodeHasALengthValidationConstraint() throws Exception {
        int databaseSizeBeforeTest = addressRepository.findAll().size();
        // set the field null
        address.setZipCode(NOT_VALID_UPDATED_ZIPCODE);
    ...
    @Test
    @Transactional
    public void checkCountryCodeHasALengthValidationConstraint() throws Exception {
        int databaseSizeBeforeTest = addressRepository.findAll().size();
        // set the field null
        address.setCountryCode(NOT_VALID_UPDATED_COUNTRY_CODE);
