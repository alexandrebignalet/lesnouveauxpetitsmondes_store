...
@Component({
    selector: 'jhi-category-lpnm',
    templateUrl: './category-lpnm.component.html'
})
export class CategoryLpnmComponent implements OnInit, OnDestroy {
categories: CategoryLpnm[];
    ...
    trackId(index: number, item: CategoryLpnm) {
        return item.id;
    }
