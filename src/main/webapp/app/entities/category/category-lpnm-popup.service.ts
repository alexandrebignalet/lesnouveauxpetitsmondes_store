...
@Injectable()
export class CategoryLpnmPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.categoryModalRef(component, new CategoryLpnm());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    categoryModalRef(component: Component, category: CategoryLpnm): NgbModalRef {
