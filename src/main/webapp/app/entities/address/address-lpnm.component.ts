...
@Component({
    selector: 'jhi-address-lpnm',
    templateUrl: './address-lpnm.component.html'
})
export class AddressLpnmComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: AddressLpnm) {
        return item.id;
    }
