...
export class UserExtraInfoService {
    ...
    create(userExtraInfo: UserExtraInfo): Observable<UserExtraInfo> {
    ...
    update(userExtraInfo: UserExtraInfo): Observable<UserExtraInfo> {
        const copy = this.convert(userExtraInfo);
    ...
    find(id: number): Observable<UserExtraInfo> {
     ...
     */
    private convertItemFromServer(json: any): UserExtraInfo {
        const entity: UserExtraInfo = Object.assign(new UserExtraInfo(), json);
        return entity;
    }
